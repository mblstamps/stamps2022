...
this will show you all the order level classifications.
...
Now, we can run the script on the MAG classifications and produce a taxonomy file:
```
...
Install a number of R packages with conda (~2 minutes) -
```
